...
#
#  before do
#    @template_main = mock_model(Template, :layout_name => "application", :blocks => [])
#    Template.stub!(:first).and_return(@template_main)
#    @template = mock_model(Template, :name => "template example", :id => 1, :layout_name => "application")
...
#
#  before do
#    @template_main = mock_model(Template, :name => "application", :id => 2, :content => "<div></div>", :main => true, :layout_name => "application", :blocks => [])
#    Template.stub!(:first).and_return(@template_main)
#    @template = mock_model(Template, :name => "template example", :id => 1, :content => "<div></div>", :layout_name => "application")
...
#
#  before do
#    @template_main = mock_model(Template, :name => "application", :id => 2, :main => true, :layout_name => "application", :blocks => [])
#    Template.stub!(:first).and_return(@template_main)
#    @template = mock_model(Template, :to_param => "1", :save => true, :name => "template example", :id => 1, :content => "<div></div>", :layout_name => "application")
#    Template.stub!(:new).and_return(@template)
#    @template.stub!(:save).and_return(true)
#    @params = valid_template_attributes
#  end
#
#  def do_post
...
#    @template_main = mock_model(Template, :name => "application", :id => 2, :main => true, :layout_name => "application", :blocks => [])
#    Template.stub!(:first).and_return(@template_main)
#    @template = mock_model(Template, :to_param => "1", :update_attributes => true, :name => "template example", :id => 1, :content => "<div></div>", :layout_name => "application")
#    @template.stub!(:save).and_return(true)
#    Template.stub!(:find).with("1").and_return(@template)
#  end
#
...
#    @template_main = mock_model(Template, :name => "application", :id => 2, :main => true, :layout_name => "application", :blocks => [])
#    Template.stub!(:first).and_return(@template_main)
#    @template = mock_model(Template, :destroy => true, :name => "template example", :id => 1, :content => "<div></div>", :layout_name => "application")
#    Template.stub!(:find).with("1").and_return(@template)
#    @template.stub!(:destroy).and_return(true)
#  end
#
#  def do_delete
#    delete :destroy, :id => "1"
