...
#    @site = mock_model(Site, :name => "Sample site", :id => 1)
...
#                            :site_id => "1"
#                            )
#    @site.stub!(:templates).and_return([@template])
#  end
#
#  def do_get
#    get :index
...
#    @page.stub!(:site_id=).and_return(@page)
#    @site = mock_model(Site, :name => "Sample site", :id => 1)
#    Site.stub!(:first).and_return(@site)
#    @template = mock_model(Template,
#                           :name => "template example",
...
#                        )
#    Page.stub!(:find).with("1").and_return(@page)
#    @page.stub!(:update_attributes).and_return(@page)
#    @page.stub!(:save).and_return(true)
#    @site = mock_model(Site, :name => "Sample site", :id => 1)
#    Site.stub!(:first).and_return(@site)
#    @template = mock_model(Template,
